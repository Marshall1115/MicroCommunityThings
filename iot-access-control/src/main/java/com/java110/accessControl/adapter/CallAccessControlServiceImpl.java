package com.java110.accessControl.adapter;
...
import com.java110.core.dao.IMachineFaceServiceDao;
...
import com.java110.core.service.machine.IOperateLogService;
...
//        }
    ...
    public void saveFaceResult(OpenDoorDto openDoorDto) throws Exception {
        ...
        apiInnerServiceImpl.sendInfo(JSONObject.toJSONString(openDoorDto), machineDtos.get(0).getMachineId());
