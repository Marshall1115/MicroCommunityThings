...
import com.java110.core.adapt.accessControl.sxoa.FaceFeatureResultDto;
import com.java110.core.adapt.accessControl.sxoa.SxAddMachineResultDto;
import com.java110.core.adapt.accessControl.sxoa.SxCommunityDto;
import com.java110.core.dao.IMachineServiceDao;
import com.java110.core.dao.ISxoaCommunityServiceDao;
...
public class SxoaAssessControlProcessAdapt extends DefaultAbstractAccessControlAdapt {
    ...
    public void openDoor(MachineDto machineDto) {
        ...
        paramIn.put("owDeviceId", machineDto.getThirdMachineId().split("::")[1]);
