...
public class ZhenshiByteToString {
    ...
    public static boolean sendScreenCmd(MachineDto machineDto, byte[] cmd) {
        IGatewayNettySocketHandle gatewayNettySocketHandleImpl = ApplicationContextFactory.getBean("gatewayNettySocketHandleImpl", IGatewayNettySocketHandle.class);
...
//        return true;
        ...
        try {
            ...
            gatewayNettySocketHandleImpl.sendMsg(machineDto, null, cmd);
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("Error:" + e.getMessage());
            return false;
    ...
    public static boolean sendCmd(MachineDto machineDto, String cmd) {
        ...
        try {
            ...
            header[7] += (byte) (len & 0xFF);
            //CarNettyClient.sendMsg(machineDto, header);
            gatewayNettySocketHandleImpl.sendMsg(machineDto, header);
        } catch (Exception e) {
            System.out.println("Error:" + e.getMessage());
            return false;
        }
    ...
    public static boolean sendKeepAlive(MachineDto machineDto) {
        ...
        try {
            ...
            gatewayNettySocketHandleImpl.sendMsg(machineDto, buff);
        } catch (Exception e) {
            System.out.println("Error:" + e);
            return false;
        }
