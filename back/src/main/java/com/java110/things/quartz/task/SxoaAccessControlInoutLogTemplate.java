...
import com.java110.things.adapt.accessControl.sxoa.SxoaQueryAccessControlInoutLogAdapt;
 ...
 **/
@Component
public class SxoaAccessControlInoutLogTemplate extends TaskSystemQuartz {
    ...
    @Autowired
    private SxoaQueryAccessControlInoutLogAdapt sxoaQueryAccessControlInoutLogAdapt;
    ...
    protected void process(TaskDto taskDto) throws Exception {
        sxoaQueryAccessControlInoutLogAdapt.query();
    }
