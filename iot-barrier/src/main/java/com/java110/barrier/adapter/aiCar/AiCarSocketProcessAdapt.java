package com.java110.barrier.adapter.aiCar;


import com.alibaba.fastjson.JSONObject;
import com.java110.barrier.adapter.DefaultAbstractCarProcessAdapt;
import com.java110.core.adapt.ICallAccessControlService;
import com.java110.entity.car.Java110CarProtocol;
import com.java110.entity.accessControl.CarResultDto;
...
public class AiCarSocketProcessAdapt extends DefaultAbstractCarProcessAdapt {
    ...
    @Autowired
    private IGatewayNettySocketHandle gatewayNettySocketHandleImpl;
    ...
    public ResultDto addCar(MachineDto machineDto, CarDto carResultDto) {
        ...
        JSONObject resultJson = gatewayNettySocketHandleImpl.sendMsgSync(java110CarProtocol, carResultDto.getCarNum());
...
//                break;
    ...
    public TempCarPayOrderDto getNeedPayOrder(MachineDto machineDto, CarDto carDto) {
        ...
        java110CarProtocol.setContent("{\n" +
                ...
                "    \"pay_scene\": 0\n" +
                "  }");
        JSONObject data = gatewayNettySocketHandleImpl.sendMsgSync(java110CarProtocol, carDto.getCarNum());
